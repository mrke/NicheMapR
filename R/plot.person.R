...
#' @param SHAPE_Bs = c(1.580000, 2.086246, 13.009215, 7.000000), #
...
#' @usage plot_person(MASSs = c(5.32, 35.07, 3.43, 11.34), HEIGHT = 170, DENSITYs = rep(1050, 4), SHAPE_Bs = c(1.75, 1.87, 6.65, 6.70))
#' @export
plot_human <- function(
    MASS = 70,
    HEIGHT = 170,
    ...
    SHAPE_Bs = c(1.580000, 2.086246, 13.009215, 7.000000),
