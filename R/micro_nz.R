...
micro_nz <- function(loc="Dunedin, New Zealand",timeinterval=365,ystart=2000,yfinish=2000,
  ...
  LAI=0.1,
  snowmodel=1,snowtemp=1.5,snowdens=0.375,densfun=c(0,0, 0, 0),snowmelt=0.9,undercatch=1,rainmelt=0.0125,
  shore=0,tides=matrix(data = 0, nrow = 24*timeinterval*nyears, ncol = 3), scenario="", year="", barcoo="",
  quadrangle=1,hourly=0, rainhourly = 0, rainhour = 0, rainoff=0, lamb = 0, IUV = 0, soilgrids = 0, IR = 0, forecast = 0, message = 0, fail = nyears * 24 * 365, snowcond = 0, intercept = maxshade / 100 * 0.3) {
  #
