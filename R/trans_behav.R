...
#' @param CT_max = 43, # core temperature (°C)
...
press = 101325) {
  ...
  colnames(sumstats) = c("doy", "max_foraging_bout", "sum_activity", "bouts", "morning_bask", "morning_forage", "first_midday_bout", "mean_midday_bout", "afternoon",
                         "mrate_sum", "mrate_sum_inactive", "mrate_sum_active")
  ...
  # summarise activity time and maximum bout length per hour
  for (i in 0:23) {
  ...
  day_results <- day_results[, c(2, 1, 13, 3, 4, 11, 10, 5:9, 12)]
  colnames(day_results) <- c("time", "hour", "T_air_shd", "Tb", "Tb_final", "Tb_open", "Te_open", "time_constant", "dTb_dt", "posture", "active", "state", "mrate")
  colnames(act_window) <- c("time", "forage", "max_foraging_bout")
  colnames(sum_stats) <- c("loc", "Ww_g", "T_F_min", "T_F_max", "max_foraging_bout", "sum_activity", "bouts", "morning_bask", "morning_forage",
                         "first_midday_bout", "mean_midday_bout", "afternoon_forage", "mrate_sum", "mrate_sum_inactive", "mrate_sum_active", "T_F_max_time_Te", "CT_max_time_Te",
                         "T_F_max_time_Tb_open", "CT_max_time_Tb_open", "T_F_maxtime", "CT_max_time", "max_Tb_open", "min_Tb_open", "max_Te", "min_Te",
                         "max_Tb", "min_Tb")
  colnames(sum_stats) <- c("loc", "Ww_g", "T_F_min", "T_F_max", "max_foraging_bout_sun", "max_foraging_bout_shd", "sum_activity_sun", "sum_activity_shd", "bouts_shd", "bouts_shd", "morning_bask", "morning_forage_sun", "morning_forage_shd",
