...
#' @param Tb_init initial temperature (degrees C) Organism shape, 0-5, Determines whether standard or custom shapes/surface area/volume relationships are used: 0=plate, 1=cyl, 2=ellips, 3=lizard (desert iguana), 4=frog (leopard frog), 5=custom (see details)
...
#' @param geom Organism shape, 0-5, Determines whether standard or custom shapes/surface area/volume relationships are used: 0=plate, 1=cyl, 2=ellips, 3=lizard (desert iguana), 4=frog (leopard frog), 5=custom (see parameter 'customallom')
...
#' @param Tairf air temperature function with time, generated by 'approxfun' (degrees C)
#' @param Tradf radiant temperature function with time, generated by 'approxfun'(degrees C), averaging ground and sky
...
#' @usage ode(y = Tb_init, times = times, func = onelump_varenv_ode, parms = indata)
#' @examples
#' library(NicheMapR)
#' library(deSolve)
#'
...
#'
#'   Tbs_ode <- as.data.frame(ode(y = Tb_init, times = times, func = onelump_varenv_ode3, parms = indata))
