...
#' @param Tsk_init = 5.1, initial shell (skin) temperature (deg C)
#' @param Ts_init = 5.2, initial surface temperature (deg C)
...
#' @return Tsk 'Skin' / shell temperature (deg C)
#' @return Ts Outer surface temperature (deg C)
