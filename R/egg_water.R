...
#' @param Ww_g = -707, water potential of freshly laid egg (J/kg)
...
#' @param Tsoilf air temperature function with time, generated by 'approxfun' (°C)
#' @param Tbf radiant temperature function with time, generated by 'approxfun'(°C), averaging ground and sky
#' @param RHsoilf wind speed function with time, generated by 'approxfun' (m/s)
#' @param PSIsoilf radiation function with time, generated by 'approxfun' (W/m2)
...
#' spec_hyd <- 0.0304 / 100 # cm3 cm-3 (J/kg)-1, water potential-specific hydration, empirically determined from linear model
