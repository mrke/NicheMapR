  ...
  if(errors==0){ # continue
    ...
    if(save != 2){
      if(opendap == 1){
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "tmmn_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "tmmx_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "rmin_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "rmax_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "pr_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "srad_1979_CurrentYear_CONUS#fillmismatch.nc"))
        ...
        nc <- RNetCDF::open.nc(paste0(baseurl, "vs_1979_CurrentYear_CONUS#fillmismatch.nc"))
