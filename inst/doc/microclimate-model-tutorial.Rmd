...
```
This vignette provides a detailed tutorial of the Niche Mapper microclimate model as implemented in the package *NicheMapR*. See the [microclimate](microclimate-model-tutorial.Rmd) vignette for details on the underlying theory and equations.
