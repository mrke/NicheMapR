...
*Name*                    | *Units *          |	*Allowed Range*   |	*Description*
------------------------- | ----------------- | ----------------- | --------------
SLES                      | -                 | 0 or 1               | substrate longwave IR emissivity$^1$ 
REFLS                      | -                 | 0 or 1               | substrate solar reflectivity$^1$ 
CMH2O                     | cm                | 0.1-2             | precipitable cm H$_2$O in air column
TAI                       | -                 | 1-doynum          | aerosol optical extinction coefficients$^{1,2}$ 
solonly                   | -                | 0 or 1             | flag to do only solar calcs
lamb                     | -                | 0 or 1             | flag to return wavelength-specific solar radiation output
IUV                      | -                | 0 or 1             | flag to use gamma function for scattered solar radiation$^{3}$
ndmax                      | -                | >=1             | iterations of first day to get a steady periodic$
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
