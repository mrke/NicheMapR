...
## ---- warning=FALSE, message=FALSE---------------------------------------
ecto <- ectotherm(Ww_g = Ww_g, alpha_max = alpha_max, alpha_min = alpha_min, pct_wet = pct_wet,
...
## ---- fig.width=7, fig.height=5, fig.show = "hold", message=FALSE, warnings=FALSE, fig.cap="**Body temperature, depth, shade and activity of for the lizard *Eulamprus quoyii* with shade options ranging from 0% to 90%**"----
...
text(0.5, T_F_max + 2, "T_F_max", col = 'red')
...
## ---- echo=FALSE, fig.width=7, fig.height=5, fig.show = "hold", message=FALSE, warnings=FALSE, fig.cap="**Body temperature, depth, shade and activity of for the lizard *Eulamprus quoyii* with shade options ranging from 0% to 10%**"----
...
with(environ, plot(TC ~ dates, ylab = "T_b, depth, activity and shade", xlab = "month of year", ylim = c(0, 50), type = "l"))
with(environ, points(ACT * 5 ~ dates, type = "l", col = "orange"))
with(environ, points(SHADE / 10 ~ dates, type = "h", col = "dark green"))
with(environ, points(DEP / 10 ~ dates, type = "l",col = "brown"))
abline(T_F_max, 0, lty = 2,col = 'red')
