...
$^{1}$As a function of day of year (1 to 365 in southern hemisphere, 183-182 in northern hemisphere), in units of Mg m$^{-3}$ - if it is c(0,0) then fixed density used 
