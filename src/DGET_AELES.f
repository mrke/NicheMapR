...
C     REPRODUCTION BUFFER AND STOMACH ENERGY FOR AN INSECT LARVA
      ...
      E_S= max(0.0D0,AELES(5))! % J, STOMACH ENERGY
      ...
      IF(E_S .LT. P_A)THEN                    ! NO ASSIMILATION IF STOMACH TOO EMPTY
       DE = MAX(0.0D0, E_S) - P_C                         ! J/TIME, CHANGE IN RESERVE, NOTE MULTPLYING BY V SINCE ALREADY DIVIDED BY L_B WHICH IS THE SAME AS MULT BY V^2/3 AND BY L/L_b
      ELSE
