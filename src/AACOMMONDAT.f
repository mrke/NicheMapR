...
C     DEFINES DYNAMICALLY VARYING ARRAYS AND VECTORS
     ...
     & ,RAINFALL2(:),RAINHR(:),S_INSTAR(:),TBS(:),THERMAL_STAGES(:,:)
     & ,TRANSIENT(:),WATER_STAGES(:,:),WETLANDDEPTHS(:),WETLANDTEMPS(:)
     & ,XP(:),YP(:),ZD1(:),ZD2(:),ZD3(:),ZD4(:),ZD5(:),ZD6(:),ZD7(:)
     & ,ZP1(:),ZP2(:),ZP3(:),ZP4(:),ZP5(:),ZP6(:),ZP7(:),FEC(:),SURV(:)
     & ,ACT(:),FOR(:),LX(:),MX(:)
