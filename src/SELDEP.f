...
C     DEPTH IN THE SOIL WHERE IT CAN BE WITHIN TOLERABLE TEMPERATURES
      ...
      DOUBLE PRECISION EMISSK,FLUID,G,H2O_BALPAST,HSOIL,MAXTEMP,MICRO
      DOUBLE PRECISION NEWDEP,POND_DEPTH,PTCOND,PTCOND_ORIG,QSOL,QSOLR,R
      DOUBLE PRECISION RELHUM,RH,RHREF,SUBTK,TA,TALOC,TANNUL,TBASK,TC
      DOUBLE PRECISION TDIGPR,TEMERGE,TIME,TMAXPR,TMINPR,TOBJ,TPREF,TR
      DOUBLE PRECISION TREF,TSKIN,TSKY,TSKYC,TSMAX,TSMIN,TSOIL,TSUB
      DOUBLE PRECISION TSUBST,TWATER,VEL,VLOC,VREF,WEVAP,Z,ZMAX,ZMIN
      ...
      DIMENSION HSOIL(25),QSOL(25),RH(25),RHREF(25),TALOC(25),TIME(25)
      DIMENSION TREF(25),TSKYC(25),TSOIL(10),TSUB(25),VLOC(25),VREF(25)
      DIMENSION Z(25),ZSOIL(10)
