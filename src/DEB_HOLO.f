...
C     IMPLEMENTATION OF LLANDRES ET AL. (2015) DEB MODEL FOR INSECTS - 26 DEC 2013
      ...
      DOUBLE PRECISION WORK,RPAR,RTOL,ATOL,YY,XEND,X
     ...
     &ATOL(1)
      ...
      DOUBLE PRECISION RELHUM,REPRO,REPRODENS,RH,RHO1_3,RHREF,RQ,S_G,S_J
      DOUBLE PRECISION SCALED_L,SIDEX,SIG,STAGE,STAGE_REC,SURVIV
      DOUBLE PRECISION SURVIV_INIT,SURVIV_PRES,T_A,T_AH,T_AL,T_H,T_L
      DOUBLE PRECISION T_REF,TALOC,TB,TBASK,TC,TCORES,TCORR,TDIGPR
      ...
      DIMENSION FAECES(24),FOOD(50),GH2OMET(24),HRN(24),HS(24)
