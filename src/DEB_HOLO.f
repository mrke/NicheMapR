...
C     IMPLEMENTATION OF LLANDRES ET AL. (2015) DEB MODEL FOR INSECTS
     ...
     &ATOL(1),VSTI(NDGL)
      ...
      DOUBLE PRECISION K_JREF,K_M,KAP,KAP_G,KAP_R,KAP_V,KAP_X,KAP_X_P
      DOUBLE PRECISION K_EL,K_EV,KT_E,KT_EL,KT_EV,KT_J,KT_MDOT,L_B,L_J
      DOUBLE PRECISION L_J2,L_M,L_PRES,L_T,L_THRESH,L_W,L_WREPRO,LAMBDA
      DOUBLE PRECISION LAT,LENGTHDAY,LENGTHDAYDIR,LONGEV,M_V,MAXMASS
      DOUBLE PRECISION MINCLUTCH,MINED,MLO2,MLO2_INIT,MONMATURE,MONREPRO
      DOUBLE PRECISION MR_1,MR_2,MR_3,MU_AX,MU_E,MU_P,MU_V,MU_X
      DOUBLE PRECISION NEWCLUTCH,NWASTE,O2FLUX
