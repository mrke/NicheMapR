...
C     IMPLEMENTATION OF LLANDRES ET AL. (2015) DEB MODEL FOR INSECTS - 26 DEC 2013
     ...
     &ATOL(1)
      ...
      DOUBLE PRECISION HS_PRES,JM_JO,JMCO2,JMCO2_GM,JMH2O,JMH2O_GM
      DOUBLE PRECISION JMNWASTE,JMNWASTE_GM,JMO2,JMO2_GM,JOJE,JOJE_GM
      DOUBLE PRECISION JOJP,JOJP_GM,JOJV,JOJV_GM,JOJX,JOJX_GM,K_JREF,K_M
      DOUBLE PRECISION KAP_R,KAP_X,KAP_X_P,KAPPA,KAPPA_G,KT_E,KT_EL,KT_J
      DOUBLE PRECISION KT_MDOT,L_B,L_J,L_J2,L_M,L_PRES,L_T,L_THRESH,L_W
      ...
      DOUBLE PRECISION ORIG_ESM,P_A,P_AM,P_AM_ACC,P_B,P_B_PAST,P_C,P_C2
      DOUBLE PRECISION P_D,P_G,P_J,P_M,P_MREF,P_MV,P_R,P_X,P_XM_ACC
      DOUBLE PRECISION P_XMREF,PFEWAT,PHI,PHIMAX,PHIMIN,PI,POND_DEPTH
      ...
      DOUBLE PRECISION QSEVAP,QSOL,QSOLAR,R,RAINDRINK,RAINFALL,RELHUM
      DOUBLE PRECISION REPRO,REPRODENS,RH,RHO1_3,RHREF,RQ,S_G,S_J
      ...
      DIMENSION FAECES(24),FOOD(50),GH2OMET(24),HS(24),JM_JO(4,4)
      DIMENSION L_W(24),MLO2(24),NWASTE(24),Q(24),QSOL(25),REPRO(24)
      DIMENSION RH(25),RHREF(25),STAGE_REC(25),SURVIV(24),TCORES(25)
      DIMENSION TSKYC(25),V(24),V_BABY1(24),VOLD(24),VPUP(24)
...
C       O2FLUX = (-1*JMO2*(0.082058*(TB+273.15))/
C     &  (0.082058*293.15))*24.06*1000
      ELSE
...
C     MLO2/H, STP
      MLO2(HOUR) = -1*JMO2/(T_REF/TB/24.4)*1000/TCORR
C     MLO2(HOUR) = (-1*JMO2*(0.082058*(TB+273.15))/
C     & (0.082058*293.15))*24.06*1000
