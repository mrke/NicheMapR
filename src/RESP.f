...
C     ALONG WITH THIS PROGRAM. IF NOT, SEE HTTP://WWW.GNU.ORG/LICENSES/.
      ...
      DOUBLE PRECISION AIRATO,AIRML1,AIRML2,AIRVOL
      DOUBLE PRECISION AL,ALT,AMASS,ATOT,BP,FLSHCOND
      DOUBLE PRECISION CO2GAS,CO2MOL,CP,DB,DELTAR,DENAIR,DEPSUB,DP
      DOUBLE PRECISION E,EMISAN,ESAT,EVPMOL,EXTREF,FATOSK,FATOSB
      DOUBLE PRECISION GMASS,GEVAP,HTOVPR,KGEVAP,O2STP
      DOUBLE PRECISION N2GAS,N2MOL1,N2MOL2,O2GAS,O2MOL1,O2MOL2,O2MOLC
      DOUBLE PRECISION PCTCO2,PCTO2,PCTN2,PO2,PTCOND,QSOLAR
      DOUBLE PRECISION QCOND,QCONV,QIRIN,QIROUT,QMETAB,QRESP,QSEVAP
      DOUBLE PRECISION R,REFPO2,RELHUM,RELXIT,RGC,RHSAT
      DOUBLE PRECISION RPCTCO2,RPCTN2,RPCTO2,RQ,RW
      DOUBLE PRECISION SIG,SUBTK
      DOUBLE PRECISION VD,TA,TAIR,TC,TDIGPR,TLUNG
      DOUBLE PRECISION TMAXPR,TMINPR,TSKIN,TR,TSUBST,TBASK,TEMERGE
      DOUBLE PRECISION TVIR,TVINC,VEL,VO2CON,H2O_BALPAST
      DOUBLE PRECISION WEVAP,WTRPOT,WB,WMOL1,WMOL2,XCALC,XTRY
      DOUBLE PRECISION TPREF,PTCOND_ORIG,PFEWAT
      DOUBLE PRECISION CUSTOMGEOM,MLO2,GH2OMET,DEBQMET,SHP
      DOUBLE PRECISION ANDENS,ASILP,EMISSB,EMISSK,FLUID,G
      DOUBLE PRECISION MLO2_INIT,GH2OMET_INIT,DEBQMET_INIT,FOODWATERCUR
      DOUBLE PRECISION T_A,T_AL,T_AH,T_L,T_H,T_REF,TCORR,DRYFOOD,FAECES
      DOUBLE PRECISION MR_1,MR_2,MR_3,NWASTE,SIDEX,WQSOL
     ...
     &,F61,TQSOL,A1,A2,A3,A4,A4B,A5,A6,F13,F14,F15,F16
      ...
      INTEGER IHOUR,DEB1,GEOMETRY,NODNUM,WINGMOD,WINGCALC
