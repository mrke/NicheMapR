...
C     IT CHOOSES THE DEPTH AND RESETS THE ENVIRONMENT ACCORDINGLY
      ...
      DOUBLE PRECISION F51,F52,F61,FATOSB,FATOSK,FLSHCOND,FLUID,G,HSHSOI
      DOUBLE PRECISION HSOIL,MAXSHD,MSHSOI,MSOIL,NEWDEP,PHI,PHIMAX
      DOUBLE PRECISION PHIMIN,POND_DEPTH,PSHSOI,PSOIL,PTCOND,PTCOND_ORIG
      DOUBLE PRECISION QCOND,QCONV,QIRIN,QIROUT,QMETAB,QRESP,QSEVAP,QSOL
      DOUBLE PRECISION QSOLAR,QSOLR,REFSHD,RELHUM,RH,RHO1_3,RHREF,SHADE
      DOUBLE PRECISION SHP,SIDEX,SIG,SUBTK,TA,TALOC,TANNUL,TBASK,TC
      DOUBLE PRECISION TCORES,TDIGPR,TEMERGE,TIME,TMAXPR,TMINPR,TOBJ
      DOUBLE PRECISION TPREF,TQSOL,TRANS1,TREF,TSHSOI,TSKY,TSKYC,TSOIL
      DOUBLE PRECISION TSUB,TSUBST,TWATER,TWING,VEL,VLOC,VREF,WQSOL,Z
