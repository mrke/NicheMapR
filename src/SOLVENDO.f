...
C     USING endo_devel.R
      ...
      DOUBLE PRECISION ALENTH,AMASS,ANDENS,ANU,AREACND,AREASKIN,ASEMAJ
      DOUBLE PRECISION ASIL,ASILN,ASILP,ATOT,AWIDTH
...
111   CONTINUE
      ...
      sigma=5.6697E-8
      QIROUTD=2.*FASKY*sigma*EMISAN*AREASKIN*(TSKCALCAVD+273.15)**4.
      QIRIND=QRADD*(-1.)+QIROUTD
      QIROUTV=2.*FAGRD*sigma*EMISAN*AREASKIN*(TSKCALCAVV+273.15)**4.
