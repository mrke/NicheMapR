...
C     USING endo_devel.R
      ...
      DOUBLE PRECISION GMASS,GR,GRAV,HC,HCFOR,HD,HCFREE,HDFORC,HDFREE
      DOUBLE PRECISION HTOVPR,INPUT,IPT,IRPROPout,KEFF,KFURCMPRS,KHAIR
      DOUBLE PRECISION KSUB,LEN,LHAIRD,LHAIRV,MASBAL,MASFAT,MORPH,N2GAS
