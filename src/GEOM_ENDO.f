...
C     EFFECTIVE AREA OF SKIN THAT IS WET).
     ...
     & ,SHAPEB,SHAPEC,DHARA,RHOARA,PCOND,SAMODE,ORIENT
     & ,RESULTS)

      IMPLICIT NONE
      
      DOUBLE PRECISION A2,AHEIT,ALENTH,AMASS,ANDENS,AREA,AREASKIN,ASEMAJ
      DOUBLE PRECISION ASIL,ASILN,ASILP,ATOT,AV,AWIDTH
      DOUBLE PRECISION BSEMIN,C2,CFA,CFB,CFC,CFD,CFT1,CFT1A
      DOUBLE PRECISION CFT1B,CFT1C,CFT2,CFT2A,CFT2B,CFT3,CFT4,CFT5
      DOUBLE PRECISION CONVAR,CONVSK,CSEMIN,D,DHAIR,DHARA,E,E2
      ...
      DOUBLE PRECISION SHAPE,SHAPEB,SHAPEC,SUBQFAT,VOL,VOLFAT
