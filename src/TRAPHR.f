...
C     ON A DAILY (D) AND TOTAL TIME SELECTED (T) BASIS
      ...
      DOUBLE PRECISION DAYMET,DAYEVP,DAYEIN,DAYWIN,DAYNRG,DAYWTR
      DOUBLE PRECISION DAIR,DAYAIR,DAYCO2,DCO2,DEIN,DEVP
      DOUBLE PRECISION DMET,DNRG,DTIME,DWTR,DWIN
      DOUBLE PRECISION OLDAIR,OLDEVP,OLDMET,OLDCO2,OLDWIN
      DOUBLE PRECISION TEIN,TNRG,TEVP,TMET,TWTR,TWIN
      DOUBLE PRECISION TLUNG,EXTREF,RQ,GEVAP,DELTAR,AIRVOL,CO2MOL,QCOND
      DOUBLE PRECISION QSOLAR,QIRIN,QMETAB,QRESP,QSEVAP,QIROUT,QCONV
      DOUBLE PRECISION DIST,MR_1,MR_2,MR_3
