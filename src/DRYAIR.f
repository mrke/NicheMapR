      SUBROUTINE DRYAIR(DB,BP,ALT,PATMOS,O2GAS,N2GAS,CO2GAS,
     *DENSTY,VISDYN,VISKIN,DIFVPR,THCOND,HTOVPR,TCOEFF,GGROUP)
...
C
      ...
      DOUBLE PRECISION ALT,BP,C,DB,DENSTY,DIFVPR,GGROUP,HTOVPR,MA,PATMOS
     *,PSTD,TCOEFF,THCOND,TNOT,TSTD,VISDYN,VISKIN,VISNOT,O2GAS,N2GAS
     *,CO2GAS,R

      TSTD=273.15
      PSTD=101325.
      PATMOS=PSTD*((1.-(.0065*ALT/288.))**(5.255785959124322))
      IF(BP .LE. 0.)BP=PATMOS
      !DENSTY=BP/(288.1738573002823*(DB+TSTD))
      MA=(0.031998*O2GAS+0.02802*N2GAS+0.04401*CO2GAS)/100.
      R=8.31446261815324
      DENSTY=BP*(MA/R)/(DB+TSTD)
      VISNOT=1.8325D-5
      TNOT=296.16
      C=120.
