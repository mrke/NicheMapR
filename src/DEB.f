...
C     IF METAB_MODE=1. USES DOPRI5 ALGORITHM FOR INTEGRATION
      ...
      DOUBLE PRECISION H_AREF,HALFSAT,HS,HS_INIT,HS_PRES,JM_JO,JMCO2
      ...
      DIMENSION MLO2(24),NWASTE(24),Q(24),REPRO(24),RHREF(25)
...
C     AVERAGE LONGEVITY IN YEARS
      ...
      IF((E_PRES.LT.(P_MREF*ZFACT/KAP/VDOTREF)*0.1).AND.
     &(DEAD.EQ.0))THEN 
       DEAD=1
       LONGEV=(DAYCOUNT+HOUR/24.)/365.
       NYEAR=IYEAR
