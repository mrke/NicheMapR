...
C     IF METAB_MODE=1. USES DOPRI5 ALGORITHM FOR INTEGRATION
      ...
      DOUBLE PRECISION JOJX,JOJX_GM,K_EL,K_EV,K_J,K_JREF,K_M,KAP,KAP_V
      DOUBLE PRECISION KAP_R,KAP_X,KAP_G,KAP_X_P,L_B,L_J,L_M,L_PRES,L_T
      ...
      DOUBLE PRECISION ORIG_E_SM,P_A,P_AM,P_B,P_C,P_D,P_G,P_J,P_M
      DOUBLE PRECISION P_MREF,P_MV,P_R,P_X,P_XM,P_XMREF,PAS,PBS,PCS,PDS
      DOUBLE PRECISION PGS,PJS,PMS,PRS,PHI,PHIMAX,PHIMIN,PI,POND_DEPTH
      ...
      DOUBLE PRECISION RELHUM,REPRO,RESID,RH,RHO1_3,RHREF
      ...
      DIMENSION JM_JO(4,4),MLO2(24),NWASTE(24),PAS(24),PCS(24),PMS(24)
