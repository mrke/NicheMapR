...
C     IF METAB_MODE=1. USES DOPRI5 ALGORITHM FOR INTEGRATION
     ...
     & BREEDACTTHRES,METAMORPH,PHOTOSTART,PHOTOFINISH,BREEDACT,BATCH
      COMMON/DEBPAR3/METAB_MODE,STAGES,K_EL,K_EV,STARVEMODE
