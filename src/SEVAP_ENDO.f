...
C     FROM FLUIDPROPERTIES.jl: LATENT HEAT OF VAPORIZATION
      IF(TAIR.GT.0)THEN
        HTOVPR=(2500.8-2.36*TAIR+0.0016*TAIR**2-0.00006*TAIR**3)*1000
      ELSE
        HTOVPR=(834.1-0.29*TAIR-0.004*TAIR**2)*1000
      ENDIF
