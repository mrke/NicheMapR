...
C     COMPUTES LONGWAVE RADIATION ABSORBED
      ...
      DOUBLE PRECISION FATOSB,FATOSK,FLSHCOND,FLUID,FSKY,G,IR1,IR2,IR3
      DOUBLE PRECISION IR4,IR5,IR6,PCTDIF,PHI,PHIMAX,PHIMIN,PTCOND
      ...
      DIMENSION QSOL(25),RH(25),RHREF(25),TALOC(25),TIME(25),TREF(25)
      DIMENSION TSKYC(25),TSUB(25),VLOC(25),VREF(25),Z(25)
