...
C     YDOT = DTCORE/DTIME
      ...
      DOUBLE PRECISION GH2OMET_INIT,GMASS,GN,H2O_BALPAST,HC,HD,HR,HRN
      ...
      DOUBLE PRECISION RFLESH,RH,RHO1_3,RHREF,RHUM,RINSUL,RQ,RW,S2,SHADE
      ...
      DOUBLE PRECISION TVIR,TWING,TYM,VAR,VD,VDAIR,VDSURF,VEL,VLOC,VOL
      ...
      DIMENSION GH2OMET(24),MLO2(24),NWASTE(24),QSOL(25),RH(25),HRN(24)
