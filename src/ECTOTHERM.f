...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DIMENSION E_BABY1(24),E_H(24),E_HPUP(24),ECTOINPUT(170)
      DIMENSION ECTOINPUT1(170),ED(24),EGGSHP(3),EGGPOT(25),EGGSHPOT(25)
     ...
     & SKINT,HC,CONVAR,PMOUTH,PANT,PANTMAX,CONV_ENHANCE
