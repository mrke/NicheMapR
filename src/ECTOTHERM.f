...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION BREEDTEMPTHRESH,BREF,CAUSEDEATH,CAVE,CDS,CLUTCHA
      ...
      DOUBLE PRECISION WORK,RPAR,YY,XEND,VSTI
      ...
      DIMENSION ATSOIL(25,10),BREEDVECT(24),CDS(24),CUMBATCH(24)
      DIMENSION CUMREPRO(24),CUSTOMGEOM(8),DEBFIRST(13),DEBLAST1(13)
      DIMENSION DEBMOD1(94),DEBQMET(24),DEP1(10),DEPSEL(25),DRYFOOD(24)
      ...
      DIMENSION EPUP(24),ES(24),ETAO(4,3),FAECES(24),FOOD(50)
      DIMENSION FTRANSAR(25),GH2OMET(24),HRN(25),HS(24),HSHSOI(25)
      DIMENSION HSOIL(25),INACTIVE(25),JM_JO(4,4),L_W(24)
      DIMENSION MLO2(24),MSHSOI(25),MSOIL(25),NTRY1(24),NWASTE(24)
      DIMENSION O2WATERS(20),PHWATERS(20),PSHSOI(25),PSOIL(25),Q(24)
      DIMENSION QSOL(25),REPRO(24),RH(25),RHREF(25),RWORK(200)
...
C ---  INITIAL VALUES AND ENDPOINT OF INTEGRATION
       ...
       YY(1)=X
       YY(2)=TC
       CONTDEP=MIN(CONTDEP+RAINFALL,CONTH*10.)
       IF((RAINFALL.GT.0.).AND.(CONTH.GT.0.))THEN
        SKINW=CONTWET
        CALL GEOM
       ENDIF
