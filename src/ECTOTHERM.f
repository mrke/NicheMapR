     ...
     &,SHADHUMID1,TCOND1,SHADTCOND1,DEP1,RAINFALL1,RAINHR1,DEBMOD1
     &,DEBLAST1,FOODWATERS1,FOODLEVELS1,WETLANDTEMPS1,WETLANDDEPTHS1
     &,GLMTEMP1,GLMO21,GLMSALT1,GLMPH1,GLMFOOD1,ARRHENIUS1,ARRHENIUS12
     &,THERMAL_STAGES1,BEHAV_STAGES1,WATER_STAGES1,NUTRI_STAGES1
     &,MINSHADES1,MAXSHADES1,S_INSTAR1,ENVIRON1,ENBAL1,MASBAL1,DEBOUT1
     &,YEAROUT,YEARSOUT1)
...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION ZFACT,ZSOIL,ZTHRESH,K_BODY,SPEC_HYD,PSI_BODY
      ...
      DIMENSION E_BABY1(24),E_H(24),E_HPUP(24),ECTOINPUT(155)
      DIMENSION ECTOINPUT1(155),ED(24),EGGSHP(3),EGGPOT(25),EGGSHPOT(25)
      ...
      DIMENSION SALWATERS(20),SHD(25),SHTCOND(25),SHP(3),STAGE_REC(25)
      DIMENSION SURVIV(24),TALOC(25),TCOND(25),TCORES(25),TIME(25)
      DIMENSION TRANSAR(5,25),TREF(25),TSHLOW(25),TSHOIL(25),TSHSKI(25)
      DIMENSION TSHSOI(25),TSKYC(25),TSOIL(25),TSOILS(25),TSUB(25)
      DIMENSION TWATERS(20),V(24),V_BABY1(24),VLOC(25),VOLD(24),VPUP(24)
      DIMENSION VREF(25),WETFOOD(24),WETGONAD(24),WETMASS(24)
      DIMENSION WETSTORAGE(24),XWATERS(20),Y(10),YEAROUT(20),Z(25)
      DIMENSION ZSOIL(10),BBS(10),KSATS(10),PSI(25),LIQ(25)
     ...
     & A3,A4,A4B,A5,A6,F13,F14,F15,F16,F23,F24,F25,F26,WINGCALC,WINGMOD
      ...
      COMMON/WATERSUB/K_SAT,BB,KSATS,BBS
...
C    CHECK IF BUCKET MODEL HAS RUN (OR IF WET0D WAS RUN) AND, IF SO, SWITCH OFF POND
     ...
     &  (ECTOINPUT1(116).EQ.1))THEN
       ...
       DO 8001 I=136,145
        BBS(I-135)=ECTOINPUT1(I)
8001    CONTINUE
       DO 8002 I=146,155
        KSATS(I-145)=ECTOINPUT1(I)
8002    CONTINUE
       MINWATER=ECTOINPUT1(99)
       MICROYEAR=INT(ECTOINPUT1(100))
     ...
     &    (AQUABREED.GT.0)))THEN
        ...
        ELSE
         IF(AQUABREED.NE.1)THEN
          ...
          ENDIF
          IF(IHOUR.LT.25)THEN
           IF(V(IHOUR).EQ.0)THEN ! WAITING/DEAD, DON'T BOTHER SOLVING
            X = TA
            TC = X
            Y(NEQ)=X
            GOTO 252
          ...
          ENDIF
          IF(IHOUR.EQ.25)THEN
           IF(V(24).EQ.0)THEN ! WAITING/DEAD, DON'T BOTHER SOLVING
            X = TA
            TC = X
            Y(NEQ)=X
            GOTO 252
...
233     CONTINUE
     ...
     &     (SUM(ACTHR).EQ.0)))THEN ! NO ACTIVITY YET FOR THE DAY
         ...
         IF(BURROWSHADE.EQ.1)THEN
          SHADE=MAXSHD
          CALL SELDEP(TSHSOI,HSHSOI,ZSOIL,RELHUM,PSOIL,TCOND)
         ELSE
          SHADE=REFSHD
          CALL SELDEP(TSOIL,HSOIL,ZSOIL,RELHUM,PSHSOI,SHTCOND)
         ENDIF
...
C --- INITIAL VALUES AND ENDPOINT OF INTEGRATION
      RPAR(1)=DBLE(AV)
      RPAR(2)=DBLE(K_BODY)
      RPAR(3)=DBLE(SPEC_HYD)
      RPAR(4)=DBLE(K_SAT)
      RPAR(5)=DBLE(PSI_BODY)
      RPAR(6)=DBLE(BB)
      RPAR(7)=DBLE(WEVAP*3600.)
      RPAR(8)=DBLE(POT)
      X=0.0D0
      YY(1)=0.0D0
      YY(2)=LIQ_INIT
