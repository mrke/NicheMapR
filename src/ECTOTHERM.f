...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION K_EGG,SPEC_HYD_EGG,PSI_EGG
      ...
      DIMENSION E_BABY1(24),E_H(24),E_HPUP(24),ECTOINPUT(158)
      DIMENSION ECTOINPUT1(158),ED(24),EGGSHP(3),EGGPOT(25),EGGSHPOT(25)
