...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION FOODWATERCUR,FUN,FUNWING,FUNCT,G,G_VS_AB,G_VS_AD
      DOUBLE PRECISION GEVAP,GH2OMET,GH2OMET_INIT,GUTFILL,GUTFREEMASS
      DOUBLE PRECISION GUTFULL,H_AREF,H2O_BAL,H2O_BAL_HR
