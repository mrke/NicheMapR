...
7891   CONTINUE
     ...
     &    T1(I,19),',',DEBOUT1(I,20),',',DEBOUT1(I,21)
         ...
         IF((STAGE.GT.1).AND.(BIRTH.EQ.0))THEN
          ...
          BIRTHMASS=DEBOUT1(I,18)
         ENDIF
         ENBAL1(HCT,1)=REAL(DOY,8)
         ENBAL1(HCT,2)=REAL(IYEAR,8)
         ENBAL1(HCT,3)=REAL(DAYCOUNT,8)
         ENBAL1(HCT,4)=REAL(I-24*(DAYCOUNT-1),8)
         ENBAL1(HCT,5)=QSOLAR
         ENBAL1(HCT,6)=QIRIN
         ENBAL1(HCT,7)=QMETAB
         ENBAL1(HCT,8)=QSEVAP
         ...
         ENBAL1(HCT,13)=NTRY
         IF(WRITECSV.EQ.2)THEN
          WRITE(II3,113)REAL(DOY,8),",",REAL(IYEAR,8),",",
     &    REAL(DAYCOUNT,8),",",ENBAL1(HCT,4),",",
     &    QSOLAR,",",QIRIN,",",QMETAB,",",QSEVAP,",",QIROUT,",",
     &    QCONV,",",QCOND,",",ENB,",",REAL(NTRY,8)
         ENDIF
         ...
         IF(TC.GT.MAXTC)THEN
          MAXTC=TC
         ENDIF
         MASBAL1(HCT,1)=REAL(DOY,8)
         MASBAL1(HCT,2)=REAL(IYEAR,8)
         MASBAL1(HCT,3)=REAL(DAYCOUNT,8)
         MASBAL1(HCT,4)=REAL(I-24*(DAYCOUNT-1),8)
         MASBAL1(HCT,5)=O2FLUX
         IF(DEB1.EQ.1)THEN
          MASBAL1(HCT,6)=CO2FLUX
          MASBAL1(HCT,7)=NWASTE(IHOUR)
     ...
     &    ,",MASBAL1(HCT,18),",",MASBAL1(HCT,19)
         ...
         ENVIRON1(HCT,2)=IYEAR
         ENVIRON1(HCT,3)=DAYCOUNT
         ENVIRON1(HCT,4)=I-24*(DAYCOUNT-1)
         ENVIRON1(HCT,5)=TRANSIENT(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,6)=ENARY48(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,7)=ENARY41(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,8)=DEPSEL(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,9)=ACTHR(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,10)=ENARY43(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,11)=ENARY47(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,12)=ENARY46(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,13)=ENARY44(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,14)=ENARY45(I-24*(DAYCOUNT-1))
         ENVIRON1(HCT,15)=ENARY42(I-24*(DAYCOUNT-1))
         IF((AQUATIC.EQ.1).AND.(POND.EQ.0))THEN
          ENVIRON1(HCT,16)=ENVIRON1(HCT,14)
          ENVIRON1(HCT,17)=ENVIRON1(HCT,15)
         ELSE
          IF(CONTH.GT.0)THEN
           ENVIRON1(HCT,16)=CONTDEPTH
           ENVIRON1(HCT,17)=TRANSIENT(I-24*(DAYCOUNT-1))
