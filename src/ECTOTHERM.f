...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION P_XMREF,PANT,PANTMAX,PCTDESI,PCTDIF,PEYES
      DOUBLE PRECISION PFEWAT,PHI,PHI_INIT,PHIMAX,PHIMIN,PHMAX
      DOUBLE PRECISION PHMIN,PHWATERS,PI,PMOUTH,PO2MAX,PO2MIN,PO2THRESH
      DOUBLE PRECISION PO2WATER,POND_DEPTH,PONDMAX,PONDMIN,POTFREEMASS
      DOUBLE PRECISION PREVDAYLENGTH,PREVSTAGE,PSHSOI,PSOIL,PTCOND
      ...
      DOUBLE PRECISION SPHEAT,STAGE,STAGE_REC,SUBTK
      DOUBLE PRECISION SURVIV,SURVIV_INIT,T,T_A,T_AH,T_AL,T_H
      DOUBLE PRECISION T_L,T_REF,TA,TALOC,TANNUL,TBASK,TC,TC_OLD,TCINIT
      DOUBLE PRECISION TCORES,TDIGPR,TEIN,TEMERGE,TESTX,TEVP,TIME
      ...
      DIMENSION QSOL(25),REPRO(24),RH(25),RHREF(25)
