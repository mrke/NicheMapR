...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DIMENSION HRN(24),HS(24),HSHSOI(25),HSOIL(25),INACTIVE(25)
      DIMENSION IWORK(200),JM_JO(4,4),L_W(24),MLO2(24),MSHSOI(25)
      DIMENSION MSOIL(25),NTRY1(24),NWASTE(24),O2WATERS(20),PHWATERS(20)
...
115   FORMAT(19(1F15.3,A),1F10.3)
     ...
     & NUTRI_STAGES,ARRHENIUS,S_INSTAR,L_INSTAR,MINSHADES)
200   RETURN
      END
