...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION ZFACT,ZSOIL,ZTHRESH,K_SKIN,SPEC_HYD_BODY,PSI_BODY
      ...
      DOUBLE PRECISION K_EGG,SPEC_HYD_EGG,PSI_EGG,P_E,PES
      ...
      DIMENSION GH2OMET(24),HRN(25),HS(24),HSHSOI(10)
      ...
      DIMENSION PJS(24),PRS(24),PBS(24),PHWATERS(20),PSHSOI(10)
      DIMENSION PSOIL(10),Q(24),QSOL(25),REPRO(24),RH(25),RHREF(25)
      DIMENSION SALWATERS(20),SHD(25),SHTCOND(10),SHP(3),STAGE_REC(25)
      DIMENSION SURVIV(24),TALOC(25),TCOND(10),TCORES(25),TIME(25)
      DIMENSION TRANSAR(5,25),TREF(25),TSHLOW(25),TSHOIL(25),TSHSKI(25)
      DIMENSION TSHSOI(10),TSKYC(25),TSOIL(10),TSOILS(25),TSUB(25)
