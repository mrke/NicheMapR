...
C     MKS SYSTEM OF UNITS (J, M, KG, S, C, K, PA)
     ...
     & INTENT(IN) :: S_INSTAR1
      ...
      DOUBLE PRECISION FUNCT,G,G_VS_AB,G_VS_AD,GEVAP,GH2OMET
      DOUBLE PRECISION GH2OMET_INIT,GUTFILL,GUTFREEMASS,GUTFULL,H_AREF
      DOUBLE PRECISION H2O_BAL,H2O_BAL_HR
      ...
      DOUBLE PRECISION G_VS_AB_MAX,G_VS_AD_MAX
      ...
      INTEGER RAINHOUR,EGGMULT,ARRHEN,STARVEMODE,FOODMODE,LEAF
      ...
      DIMENSION E_BABY1(24),E_H(24),E_HPUP(24),ECTOINPUT(173)
      DIMENSION ECTOINPUT1(173),ED(24),EGGSHP(3),EGGPOT(25),EGGSHPOT(25)
...
C     REVERT TO ACTIVITY POSTURE FOR NEXT ITERATION IF >= TMINPR
      IF((TC.GE.TMINPR).AND.(POSTUR.EQ.1).AND.(LIVE.EQ.1))THEN        
       ASIL=(ASILN+ASILP)/2.
       PTCOND=PTCOND_ORIG
      ENDIF
...
C ---  CALL OF THE SUBROUTINE DOPRI5
     ...
     &  WORK,LWORK,IWORK,LIWORK,RPAR,IPAR,IDID,VSTI)
      ...
      ELSE
       ...
       PSI(IHOUR)=PSI_INIT
      ENDIF
      IF(LIQ(IHOUR).LT.(AMASS*DESIDEATH/100.))THEN ! DON'T GO BELOW LETHAL DESICATION
