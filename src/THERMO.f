...
C     COOLER TEMPERATURES AND HIGHER WIND SPEEDS.
      ...
      DOUBLE PRECISION DEPSUB,DEPTH,EMISAN,EMISSB,EMISSK,EXTREF,F12,F13
      DOUBLE PRECISION F14,F15,F16,F21,F23,F24,F25,F26,F31,F32,F41,F42
      DOUBLE PRECISION F51,F52,F61,FATOBJ,FATOSB,FATOSK,FLSHCOND,FLUID
      DOUBLE PRECISION FLYMETAB,FLYSPEED,FLYTIME,FOODLIM,G,GUTFILL
      DOUBLE PRECISION GUTFULL,HSHSOI,HSOIL,MAXSHD,MR_1,MR_2,MR_3,MSHSOI
      DOUBLE PRECISION MSOIL,NEWDEP,O2MAX,O2MIN,PCTDIF,PHI,PHIMAX,PHIMIN
      DOUBLE PRECISION PSHSOI,PSOIL,PTCOND,PTCOND_ORIG,QCOND,QCONV,QIRIN
      DOUBLE PRECISION QIROUT,QMETAB,QRESP,QSEVAP,QSOL,QSOLAR,QSOLR,QUIT
      DOUBLE PRECISION REFSHD,RELHUM,RH,RHO1_3,RHREF,RQ,SHADE,SHP,SIDEX
      DOUBLE PRECISION SIG,SPHEAT,SUBTK,TA,TALOC,TANNUL,TBASK,TC,TCORES
      DOUBLE PRECISION TDIGPR,TEMERGE,TIME,TLUNG,TMAXPR,TMINPR,TOBJ
      DOUBLE PRECISION TPREF,TQSOL,TRANS1,TREF,TSHLOW,TSHOIL,TSHSKI
      DOUBLE PRECISION TSHSOI,TSKY,TSKYC,TSOIL,TSOILS,TSUB,TSUBST,TWING
      DOUBLE PRECISION VEL,VLOC,VREF,WC,WQSOL,Z,ZEN,ZSOIL
      ...
      DIMENSION TREF(25),TSHLOW(25),TSHOIL(25),TSHSKI(25),TSHSOI(25)
      DIMENSION TSKYC(25),TSOIL(25),TSOILS(25),TSUB(25),VLOC(25)
