...
C     SOLVING THE HEAT AND WATER BALANCES, GIVEN THE CHOSEN GEOMETRY
      ...
      DOUBLE PRECISION HDFREE,NEWDEP,O2MAX,O2MIN,P,PCTDIF,PCTEYE,PCTN
      DOUBLE PRECISION PCTP,PEYES,PHI,PHIMAX,PHIMIN,PI,PTCOND
      DOUBLE PRECISION PTCOND_ORIG,QSOLR,R,R1,RAINFALL,RELHUM,RHO1_3
      DOUBLE PRECISION RINSUL,SHP,SIDEX,SIG,SKINT,SKINW,SPHEAT,SUBTK,TA
      DOUBLE PRECISION TOBJ,TOTLEN,TQSOL,TR,TRANS1,TSKIN,TSKY,TSUBST
      DOUBLE PRECISION TWING,VEL,VOL,WC,WCUT,WEVAP,WEYES,WQSOL,WRESP,ZEN
...
C      NORMAL AND POINTING @ SUN SILHOUETTE AREA: EQ'N 11 TRACY 1976
     ...
     & 4.75761E-03*ZEN**2.-0.167912*ZEN+45.8228
       ...
       AV=AREA*PTCOND
       AT=AREA*SKINT
       AEFF=SKINW*AREA-SKINW*AREA*PTCOND
     & -SKINW*AREA*SKINT
      ENDIF
