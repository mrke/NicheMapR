...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION HTOVPR,PATMOS,PCTEYE,PEYES,PHI,PHIMAX,PHIMIN,PI
      DOUBLE PRECISION PR,PR2,PTCOND,PTCOND_ORIG,QCOND,QCONV,QFORCED
      DOUBLE PRECISION QFREE,QIRIN,QIROUT,QMETAB,QRESP,QSEVAP,QSOLAR,R
      DOUBLE PRECISION RAYLEI,RE,RELHUM,RHO1_3,SC,SC2,SHFORC,SHFREE,SHP
      DOUBLE PRECISION SIDEX,SIG,SKINT,SKINW,SUBTK,TA,TCOEFF,THCOND
      DOUBLE PRECISION TOTLEN,TQSOL,TR,TRANS1,TSKIN,TSUBST,TWING,VEL
      DOUBLE PRECISION VISDYN,VISKIN,WCUT,WEVAP,WEYES,WQSOL,WRESP
