...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION RELHUM,RHO1_3,SC,SC2,SH,SHP,SIDEX,SIG
      ...
      DOUBLE PRECISION EMISSB_REF,EMISSK_REF,NUTOTAL
...
C     USING BIRD, STEWART, & LIGHTFOOT'S MIXED CONVECTION FORMULA (P. 445, TRANSPORT PHENOMENA, 2002)
      ...
      QFREE=HCFREE*CONVAR*(TSKIN-TA) ! FREE CONVECTION HEAT TRANSFER
