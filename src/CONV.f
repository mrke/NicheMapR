...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION PHIMAX,PHIMIN,PI,PMOUTH,PR,PR2,PRES,PTCOND
      DOUBLE PRECISION PTCOND_ORIG,QCOND,QCONV,QFORCED,QFREE,QIRIN
      DOUBLE PRECISION QIROUT,QMETAB,QRESP,QSEVAP,QSOLAR,R,RAYLEI,RE
      DOUBLE PRECISION RELHUM,RHO1_3,SC,SC2,SHFORC,SHFREE,SHP,SIDEX,SIG
      ...
      DOUBLE PRECISION ANDENS,ASILP,EMISSB,EMISSK,FLUID,GG
     ...
     & EGGPTCOND,POT
      ...
      COMMON/WCONV/FLTYPE
      COMMON/WDSUB1/ANDENS,ASILP,EMISSB,EMISSK,FLUID,GG,IHOUR
...
C     COMPUTING GRASHOF NUMBER      
      GR=((DENSTY**2.)*BETA*G*(D**3.)*DELTAT)/(VISKIN**2.) ! MK changed from VISDYN to VISKIN 17/3/2022
