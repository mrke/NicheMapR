...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION H2O_BALPAST,HC,HD,HDFORC,HDFREE,HTOVPR,PATMOS
      DOUBLE PRECISION PCTEYE,PEYES,PHI,PHIMAX,PHIMIN,PI,PR,PR2,PTCOND
      ...
      DOUBLE PRECISION WCUT,WEVAP,WEYES,WQSOL,WRESP
...
C     USING ALTITUDE TO COMPUTE BP (SEE DRYAIR2 LISTING)
      BP=0.0
      DB=TA

C	  GET THERMAL PROPERTIES OF DRY AIR AT CURRENT TEMP AND PRESSURE
      CALL DRYAIR2(DB,BP,ALT,PATMOS,DENSTY,VISDYN,VISKIN,DIFVPR,
...
C  **************************************************************************
   40 CONTINUE
      HC=ANU*THCOND/D ! HEAT TRANFER COEFFICIENT
      SHFORC=ANU*(SC/PR)**(1./3.) ! SHERWOOD NUMBER
      HDFORC=SHFORC*DIFVPR/D ! MASS TRANSFER COEFFICIENT
      QFORCED=HC*CONVAR*(TSKIN-TA) ! FORCED CONVECTION HEAT TRANSFER
