...
C     ALL UNITS SI  (M,KG,S,C,K,J,PA)
      ...
      DOUBLE PRECISION PHIMAX,PHIMIN,PI,PMOUTH,PR,PR2,PTCOND,PTCOND_ORIG
      DOUBLE PRECISION QCOND,QCONV,QFORCED,QFREE,QIRIN,QIROUT,QMETAB
      DOUBLE PRECISION QRESP,QSEVAP,QSOLAR,R,RAYLEI,RE,RELHUM,RHO1_3,SC
      DOUBLE PRECISION SC2,SHFORC,SHFREE,SHP,SIDEX,SIG,SKINT,SKINW,SUBTK
      DOUBLE PRECISION TA,TCOEFF,THCOND,TOTLEN,TQSOL,TR,TRANS1,TSKIN
      DOUBLE PRECISION TSUBST,TWING,VEL,VISDYN,VISKIN,WCUT,WEVAP,WEYES
      DOUBLE PRECISION WQSOL,WRESP,EGGPTCOND,POT
