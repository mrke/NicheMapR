...
C     IMPLEMENTATION OF KOOIJMAN'S KAPPA-RULE STANDARD DEB MODEL FOR VIVIPAROUSLY DEVELOPING OFFSPRING
      ...
      DOUBLE PRECISION E_BABY,E_BABY_INIT,E_EGG,E_G,E_H_INIT,E_H_PRES
      DOUBLE PRECISION E_H_START,E_HB,E_HJ,E_HP,E_HPUP_INIT,E_INIT
      DOUBLE PRECISION E_INIT_BABY,E_M,E_PRES,E_SCALED,E_TEMP,EGGDRYFRAC
      DOUBLE PRECISION EH_BABY,EH_BABY_INIT,EPUP_INIT,ES_INIT,ESM,F
      DOUBLE PRECISION FUNCT,G,H_AREF,HALFSAT,HS_INIT,K_J,K_JREF,K_M
      DOUBLE PRECISION KAP_R,KAP_X,KAP_X_P,KAPPA,L_B,L_J,L_M,L_PRES,L_T
      DOUBLE PRECISION LAMBDA,LAT,LENGTHDAY,LENGTHDAYDIR,M_V,MAXMASS
