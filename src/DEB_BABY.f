...
C     IMPLEMENTATION OF KOOIJMAN'S KAPPA-RULE STANDARD DEB MODEL FOR VIVIPAROUSLY DEVELOPING OFFSPRING
      ...
      INTEGER AQUABREED,ARRHEN,AQUASTAGE,BATCH,BREEDACT,BREEDACTTHRES
      INTEGER BREEDING,BREEDVECT,COUNTDAY,CTKILL,CTMINCUM,CTMINTHRESH
      INTEGER COND_CLUTCH,DAYCOUNT,FOODMODE,METAB_MODE,METAMORPH
      INTEGER PHOTODIRF,PHOTODIRS,PHOTOFINISH,PHOTOSTART,PREGNANT,STAGES
      INTEGER VIVIPAROUS,STARVEMODE
