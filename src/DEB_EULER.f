...
C     IF METAB_MODE=1. USES EULER INTEGRATION
      ...
      DOUBLE PRECISION HS_PRES,HRN,JM_JO,JMCO2,JMCO2_GM,JMH2O,JMH2O_GM
      DOUBLE PRECISION JMNWASTE,JMNWASTE_GM,JMO2,JMO2_GM,JOJE,JOJE_GM
      DOUBLE PRECISION JOJP,JOJP_GM,JOJV,JOJV_GM,JOJX,JOJX_GM,K_EL,K_EV
      DOUBLE PRECISION K_J,K_JREF,K_M,KAP,KAP_G,KAP_R,KAP_V,KAP_X
      DOUBLE PRECISION KAP_X_P,L_B,L_J,L_M,L_PRES,L_T,L_THRESH,L_W
      ...
      DOUBLE PRECISION PMS,PRS,PHI,PHIMAX,PHIMIN,PI,POND_DEPTH
      DOUBLE PRECISION POTFREEMASS,PREVDAYLENGTH,PTCOND,PTCOND_ORIG
      DOUBLE PRECISION Q,Q_INIT,Q_PRES,QCOND,QCONV,QIRIN,QIROUT
      DOUBLE PRECISION QMETAB,QRESP,QSEVAP,QSOL,QSOLAR,R,RAINDRINK
      DOUBLE PRECISION RAINFALL,RELHUM,REPRO,RESID,RH,RHO1_3,RHREF
      ...
      DIMENSION JM_JO(4,4),L_W(24),MLO2(24),NWASTE(24),PAS(24),PCS(24)
