...
C     AND DEBUGGING
     ...
     &S_INSTAR2,MINSHADES2
      ...
      DOUBLE PRECISION E_INIT,E_INIT_BABY,E_M2,ECTOINPUT2,ED
      ...
      DOUBLE PRECISION FOODLIM,FOODWATERCUR,FUNCT,G,GEVAP,GH2OMET
      ...
      DOUBLE PRECISION HS_INIT,HSHSOI,HSOIL,JM_JO,K_JREF,K_EL,K_EV,KAP
      DOUBLE PRECISION KAP_R,KAP_V,KAP_X,KAP_X_P,L_B,L_J,L_W,L_WREPRO
      DOUBLE PRECISION LAMBDA,LAT,LENGTHDAY,LENGTHDAYDIR,LONGEV,MAXMASS
      DOUBLE PRECISION MAXSHD,MINCLUTCH,MINED,MLO2,MLO2_INIT,MONMATURE
      DOUBLE PRECISION MONREPRO,MR_1,MR_2,MR_3,MSHSOI,MSOIL,MU_E,MU_N
      DOUBLE PRECISION MU_P,MU_V,MU_X,N2GAS,NEWCLUTCH,NEWDEP,NWASTE
      DOUBLE PRECISION O2FLUX,O2GAS,ORIG_CLUTCHSIZE,ORIG_E_SM,P_MREF
      ...
      DIMENSION DEBLAST2(13),DEBMOD2(97),DEBQMET(24),DEP2(10),DEPSEL(25)
