...
c     micro_nz, micro_uk etc. functions
     ...
     &sunsnow2,shdsnow2,plant2,shadplant2
     ...
     &,SOLRhr2,RAINhr2,ZENhr2
      double precision TIMAXS2,TIMINS2,soilprop2,microinput2,PE2,BD2,BB2
     &,KS2,L2,hori2,tai2,soilinit2,dep2,DD2
      ...
      DIMENSION TIMINS2(4),TIMAXS2(4),tai2(111),soilinit2(20),hori2(24),
     & Dep2(10),L2(19),microinput2(59),soilprop2(10,5)
...
11    continue
     ...
     &shadplant2(24*nn3,14),TAIRhr2(24*nn3),RHhr2(24*nn3),WNhr2(24*nn3)
...
57    continue
     ...
     &maxshades2,minshades2,Nodes2,timaxs2,timins2,
     ...
     &,RHhr2,WNhr2,CLDhr2,SOLRhr2,RAINhr2,ZENhr2,metout2,soil2
     &,shadmet2,shadsoil2,soilmoist2,shadmoist2,humid2,shadhumid2
     &,soilpot2,shadpot2,sunsnow2,shdsnow2,plant2,shadplant2,DRLAMBDA2
