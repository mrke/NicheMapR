...
C     AND DEBUGGING
     ...
     &G_VS_ADS2
      ...
      DOUBLE PRECISION PAS,PBS,PCS,PDS,PGS,PJS,PMS,PRS
      ...
      INTEGER VIVIPAROUS,WETMOD,WINGCALC,WINGMOD,STARVEMODE
      ...
      DIMENSION ECTOINPUT2(173),ED(24),EGGSHP(3),EH_BABY1(24),ENARY1(25)
