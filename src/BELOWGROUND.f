...
C     THIS SUBROUTINE SETS THE BELOW GROUND ENVIRONMENT WHEN AN ANIMAL GOES INTO A BURROW
      ...
      DOUBLE PRECISION VLOC,VREF,WQSOL,Z,EGGPTCOND,POT
      DOUBLE PRECISION ANDENS,ASILP,EMISSB,EMISSK,EMISSB_REF,EMISSK_REF,
     & FLUID,G

      INTEGER AQUATIC,FEEDING,INWATER,WINGCALC,WINGMOD,IHOUR
