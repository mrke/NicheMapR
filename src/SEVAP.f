...
C     SURFACE AND THE AIR, EACH AT THEIR OWN TEMPERATURE.
      ...
      DOUBLE PRECISION HDD,HDFORC,HDFREE,HTOVPR,MR_1,MR_2,MR_3,MW
      DOUBLE PRECISION PANT,PANTMAX,PATMOS,PEYES,PHI,PHIMAX,PHIMIN
      DOUBLE PRECISION PMOUTH,PRES,PSIBODY,PSTD,PTCOND,PTCOND_ORIG,QCOND
...
C      RH = 100.
      RH = exp(PSIBODY/(RG/MW*(TSKIN+273.15)))*100 ! FROM JULY 2022 MAKING SKIN RH A FUNCTION OF BODY WATER POTENTIAL 
      DB=TSKIN
      IF (LIVE .EQ. 1) THEN
