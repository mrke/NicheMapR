...
C     SURFACE AND THE AIR, EACH AT THEIR OWN TEMPERATURE.
      ...
      DOUBLE PRECISION HDFORC,HDFREE,HTOVPR,MR_1,MR_2,MR_3,O2MAX,O2MIN
      DOUBLE PRECISION PATMOS,PCTEYE,PEYES,PHI,PHIMAX,PHIMIN,PSTD,PTCOND
      DOUBLE PRECISION PTCOND_ORIG,QCOND,QCONV,QIRIN,QIROUT,QMETAB,QRESP
      DOUBLE PRECISION QSEVAP,QSOLAR,R,RAINFALL,RELHUM,RH,RHO1_3,RQ,RW
      DOUBLE PRECISION SHP,SIDEX,SIG,SKINT,SKINW,SPHEAT,SUBTK,TA,TAIR
      DOUBLE PRECISION TBASK,TC,TDIGPR,TEMERGE,TLUNG,TMAXPR,TMINPR,TPREF
      DOUBLE PRECISION TQSOL,TR,TRANS1,TSKIN,TSUBST,TVINC,TVIR,TWING,V
      DOUBLE PRECISION VD,VDAIR,VDSURF,VEL,WATER,WB,WCUT,WEVAP,WEYES
      DOUBLE PRECISION WQSOL,WRESP,WTRPOT,XTRY
