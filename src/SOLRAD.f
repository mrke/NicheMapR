...
C     WATER VAPOUR OPTICAL DEPTHS. THE ORIGINAL TABLE HAD ZEROS AT THE
C     CENTRES OF THE STRONG WATER BANDS (1400, 1420, 1900, 2600, 2700,
C     2800 NM), WHICH MADE THEM TRANSPARENT. THEY ARE SET OPAQUE (80,
C     THE CAP ON TLAM), AS FITTED AGAINST RRTMGP BAND TRANSMISSION.
     ...
     &0.036,0.215,0.25,0.136,0.058,0.047,0.036,0.042,0.098,0.044,0,
     &0.038,0.83,80.,80.,0.38,0.289,0.258,0.173,0.008,0,0,0,0,0,0,0,0,
     &0.57,0.76,80.,0.185,0.291,0.178,0.196,0.112,0.075,0.074,0.07,
     &0.007,0,0,0,0.086,0.122,0.132,0.14,0.207,0.259,80.,80.,80.,0.549,
     &0.297,0.462,0.52,0.374,0.222,0.614,0.058,0.038,0.03,0.04,0.16/
