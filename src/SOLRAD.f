...
C     REPINT(N)    RECIPROCAL OF EPINT
     ...
     & ,I94,I95,I96,I102,I103,I104,I105,I106,I107
      ...
      DIMENSION S(11),ER(7),FD(19,11),FDQ(19,11)
     ...
     * AZMUTH,SLOPE,TSNHR,TSRHR,Hemis
     ...
     &0E-01,1.40E-01,8.00E-02,3.10E-02,1.20E-02/
      ...
      DATA ER/6.19D+00,6.86D+00,1.16D+01,2.51D+01,2.24D+02,5.60D+02,1.16
     &D+03/
...
c     polynomials to the ALTFCT data originally in SOLAR.DAT and now stored above
      ALT=ALTT/1000.D0+1.D0
      ALTFCT1=0.00007277*ALT**3+0.00507293*ALT**2-0.12482149*ALT+
     &1.11687469
      ALTFCT2=8.35656D-07*ALT**6-6.26384D-05*ALT**5+1.86967D-03*ALT**4-
     &2.82585D-02*ALT**3+2.26739D-01*ALT**2-9.25268D-01*ALT+1.71321D+00
      ALTFCT3=1.07573D-06*ALT**5-5.14511D-05*ALT**4+7.97960D-04*ALT**3-
     &4.90904D-03*ALT**2 + 2.99258D-03*ALT + 1.00238D+00
      ALTFCT4=1
...
C      AS FD(I,N) AND FDQ(I,N) WHERE N IS THE WAVELENGTH INDEX AND I IS
