...
In this simulation the lizard is growing at constant temperature (25 &deg;C) and *ad libitum* constant food. Under these conditions, the DEB standard model equates to the von Bertalanffy growth equation from the point of birth. Note that the reasoning that leads to von Bertalanffy growth being a special case of DEB theory is not the same as that used by P&uutter (1920) to derive the original 'von Bertalanffy' growth equation.
...
P&uuml;tter, A. 1920. Studien &uuml;ber physiologische &Auml;hnlichkeit. VI. Wachstums&auml;hnlichkeiten. Pfl&auml;gers Archiv f&uuml;r die gesamte Physiologie des Menschen und der Tiere 180:298-340.
