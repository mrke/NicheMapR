...
In this simulation the lizard is growing at constant temperature (25 &deg;C) and *ad libitum* constant food. Under these conditions, the DEB standard model equates to the von Bertalanffy growth equation from the point of birth. Note that the reasoning that leads to von Bertalanffy growth being a special case of DEB theory is not the same as that used by P&auml;tter (1920) to derive the original 'von Bertalanffy' growth equation.
...
Pütter, A. 1920. Studien über physiologische Ähnlichkeit. VI. Wachstumsähnlichkeiten. Pflügers Archiv für die gesamte Physiologie des Menschen und der Tiere 180:298–340.
