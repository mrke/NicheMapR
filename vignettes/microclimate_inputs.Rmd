---
title: 'Table A2 Microclimate Model Input Data'
...
$^{1}$Fraction of sky obscured by terrain
$^{2}$vector of length = julnum
$^{3}$must be greater than minimum shade
$^{4}$drives evaporation - set internally when runmoist==1
