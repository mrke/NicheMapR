...
* **zenith_angle** - zenith angle of sun (degrees, where 90&deg; = below the horizon)
...
micromet_lowshade <- as.data.frame(micro$micromet_lowshade) # above ground microclimate
environ <- cbind(environ,micromet_lowshade$solar_radiation) # add solar radiation for activity window plots
