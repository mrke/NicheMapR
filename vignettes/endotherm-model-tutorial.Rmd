...
GMULTMAX <- 7 # maximum ratio of length to width/depth
...
plot(masbal$AIR_L / 60 * 1000 ~ TAs, ylim=c(0,250),  lty = 1, xlim=c(-5,50), main = "minute volume", ylab = "ml / min", xlab=paste("air temperature (deg C)"), type = 'l') 
