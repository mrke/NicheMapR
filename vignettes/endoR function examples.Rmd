...
This document shows how to use the function `solve.endo.R` to compute endotherm heat and mass balances. This function collates all the different steps in `endoR example.R` into a single function that can be applied to vectors of data. The `solve.endo.R` function has one behavioural option at present - sweating to cool.
...
TFA_D <- endo.out$TFA_D
TFA_V <- endo.out$TFA_V
TskinD <- endo.out$TSKIN_D
TskinV <- endo.out$TSKIN_V
TC <- endo.out$TC
